...
public class MainActivity_orig extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraButton.setOnClickListener(v -> startActivity(new Intent(MainActivity_orig.this, MainActivity.class)));
        ...
        this.sourceBitmap = Utils.getBitmapFromAsset(MainActivity_orig.this, "kite.jpg");
